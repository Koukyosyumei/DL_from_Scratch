...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        x = embedding.view(shape[0], shape[1]*shape[2])
        # END YOUR CODE
        return x
    ...
    def forward(self, t):
        ...
        hidden_1 = self.embed_to_hidden(embedding)
        hidden_2 = F.relu(hidden_1)
        hidden_3 = self.dropout_layer(hidden_2)
        logits = self.hidden_to_logits(hidden_3)
